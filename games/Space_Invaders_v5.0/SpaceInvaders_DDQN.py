...
load_agent(agent, device, 'trained_models/SpaceInvaders_DDQN_10k_Embedded.pth')
...
save_agent(agent, 'trained_models/SpaceInvaders_DDQN_10k_Embedded.pth') # Trained for: 10k Episodes           Average Human Score: 1670        Open AI DDQN: 2628 Score in 50k Episodes
