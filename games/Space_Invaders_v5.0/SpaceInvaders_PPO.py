...
load_agent_ppo(agent, device, 'trained_models/SpaceInvaders_PPO_Embedded.pth')
...
save_agent_ppo(agent, 'trained_models/SpaceInvaders_PPO_Embedded.pth')     # Open AI DDQN: 418 Score in 50k Episodes
