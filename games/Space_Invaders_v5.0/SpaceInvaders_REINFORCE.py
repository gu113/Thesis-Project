...
# Initialize Agents
agent = REINFORCEAgent(INPUT_SHAPE, ACTION_SIZE, 0, device, GAMMA, LR, REINFORCEActorCnn)
#load_agent_REINFORCE(agent, device, 'trained_models/SpaceInvaders_REINFORCE.pth')
...
#save_agent_REINFORCE(agent, device, 'trained_models/reinforce_spaceinvaders.pth')
