...
GAMMA = 0.99
BUFFER_SIZE = 25000                # Average Memory Usage: 10k -> 2GB       50k -> 5GB      100k -> 8GB     200k -> 12GB
...
#load_agent(agent, device, 'trained_models/Pong_DQN_Embedded.pth')
...
save_agent(agent, 'trained_models/Pong_DQN_Embedded.pth')     #Target Score: Agent 21 x 0 Opponent
