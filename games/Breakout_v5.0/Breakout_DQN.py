...
load_agent(agent, device, 'trained_models/Breakout_DQN_Embedded.pth')
...
save_agent(agent, 'trained_models/Breakout_DQN_Embedded.pth') #        Open AI DDQN: 418 Score in 50k Episodes
