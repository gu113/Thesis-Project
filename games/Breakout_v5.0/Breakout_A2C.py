...
# Initialize Agents
agent = ComplexA2CAgent(INPUT_SHAPE, ACTION_SIZE, 0, device, GAMMA, LR_ACTOR, LR_CRITIC, UPDATE_EVERY, A2CActorCnn, A2CCriticCnn, VALUE_LOSS_COEF, ENTROPY_COEF, GAE_LAMBDA)
#load_agent_a2c(agent, device, 'trained_models/Breakout_A2C.pth')
...
def train(n_episodes):
    ...
    for i_episode in range(1, n_episodes + 1):
        ...
        while True:
            ...
            agent.step(state, log_prob, entropy, reward, done)
...
save_agent_a2c(agent, 'trained_models/Breakout_A2C.pth')     # Open AI DDQN: 418 Score in 50k Episodes
