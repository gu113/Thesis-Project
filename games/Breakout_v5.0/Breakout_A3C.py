...
# Import Models
from models.actor_critic_cnn import A3CActorCnn, A3CCriticCnn 

# Import Utils
from utils.save_load import save_agent_a3c, load_agent_a3c
...
# Initialize Agents
agent = A3CAgent(INPUT_SHAPE, ACTION_SIZE, 0, device, GAMMA, LR_ACTOR, LR_CRITIC, UPDATE_EVERY, A3CActorCnn, A3CCriticCnn, VALUE_LOSS_COEF, ENTROPY_COEF)
# load_agent_a3c(agent, device, 'trained_models/Breakout_A3C.pth')
...
save_agent_a3c(agent, 'trained_models/Breakout_A3C.pth')
env.close()
