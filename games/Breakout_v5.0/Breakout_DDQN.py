...
env = gym.make('ALE/Breakout-v5', frameskip=1, mode=32) # Average Human Score: Around 31 points (based on reports from DeepMind and OpenAI Gym).     mode=8 for Catch Mode   mode=32 for Breakthrough Mode
...
load_agent(agent, device, 'trained_models/Breakout_DDQN_Embedded.pth')
...
#save_agent(agent, 'trained_models/Breakout_DDQN_Embedded.pth') #        Open AI DDQN: 418 Score in 50k Episodes
